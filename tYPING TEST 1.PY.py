...
class Game:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.open_img = pygame.image.load('WELCOME PIC.jpeg')
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        s fsize)
        text = font.render(msg, 1, color)elf.bg = pygame.image.load('BACKGROUND.jpeg')
        self.bg = pygame.transform.scale(self.bg, (750, 500))

        self.screen = pygame.display.set_mode((self.w, self.h))
        pygame.display.set_caption('TYPING SPEED TEST BY TEAM TECHNICAL WIZARDS')
    ...
    def show_results(self, screen):
        if(not self.end):
            ...
            # draw icon image
            self.time_img = pygame.image.load('ICON.jpeg')
    ...
    def reset_game(self):
        ...
        msg = " I can Text faster than u Read :))"
